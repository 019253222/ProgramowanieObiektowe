...
// Klasa przechowująca tablicę, ilość wierszy, kolumn oraz funkcje, które operują na tablicy
...
/**
* Funkcja odpowiadajaca za stworzenie nowej tablicy o wybranym wymiarze i formacie
*/

void stworz_tablice(int nowy_wiersz, int nowa_kolumna);
