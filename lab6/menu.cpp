...
void wyswietl_menu (){
	...
	cout << "1. - Tworzenie nowej tablicy" << endl;
	cout << "2. - Wczytywanie tablicy" << endl;
	cout << "3. - Wyświetlenie tablicy " << endl; 
	cout << "4. - Zmiana zawartosci komorki tablicy liczbowej "  << endl;
	cout << "5. - Zmiana zawartosci komorki tablicy tekstowej " << endl;
	cout << "6. - Zmiana rozmiaru tablicy " << endl;
	cout << "7. - Sumowanie po kolumnach" << endl;
	cout << "8. - Sumowanie po wierszach" << endl; 
	cout << "9. - Wartość najmniejsza w kolumnie" << endl;
	cout << "10. - Wartosc najmniejsza w wierszu" << endl;
	cout << "11. - Wartosc najwieksza w kolumnie " << endl;
	cout << "12. - Wartosc najwieksza w wierszu" << endl;
	cout << "13. - Wartosc srednia w kolumnie " << endl;
	cout << "14. - Wartosc średnia w wierszu  " << endl;
	cout << "15. - Zapisz do pliku " << endl;
	cout << "16. - Wyłacz program" << endl; 
}
...
void informacja_zwrotna(int nr_informacji, Tablica *arr) {
	...
	switch(nr_informacji) {
		...
		case 1:
			...
			arr->stworz_tablice(nowy_wiersz, nowa_kolumna);
